...
<section class="bg-bone section-padding">
  <div class="section-container max-w-2xl">
    ...
    <a href="https://wa.me/{{ ltrim($settings->whatsapp_number, '+') }}?text={{ urlencode('Hello Nails by Mona, I\'d like to place an order.') }}" class="btn-primary mt-8 inline-flex">WhatsApp us</a>
  </div>
</section>
@endsection
