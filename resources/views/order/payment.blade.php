  ...
  <div class="max-w-5xl mx-auto px-6">
    <div class="lg:grid lg:grid-cols-[1fr_340px] lg:gap-10 items-start">
      ...
      <div>
        ...
        <p class="font-sans text-caption text-stone mb-6">No Cash on Delivery.</p>

        {{-- Full payment up front for every order (2026-09-16). --}}
        <div class="mb-8 bg-lavender-wash border-l-4 border-lavender rounded-r-xl px-5 py-4">
          <p class="font-sans text-body text-lavender-ink leading-relaxed">
            <strong>Paid in full before we start</strong> — Rs.&nbsp;{{ number_format($totals['total']) }}. Your set is made to measure, so we begin as soon as your payment is confirmed. If the fit isn't right, your first refit is free.
          </p>
        </div>
