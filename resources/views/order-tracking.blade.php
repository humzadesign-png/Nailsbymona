...
<section class="bg-bone section-padding">
  <div class="section-container max-w-lg mx-auto">
    ...
    <a href="https://wa.me/{{ ltrim($settings->whatsapp_number, '+') }}?text={{ urlencode('Hello Nails by Mona, I\'d like to check on my order.') }}" class="btn-primary mt-8 mx-auto flex w-fit">WhatsApp us</a>
  </div>
</section>
@endsection
