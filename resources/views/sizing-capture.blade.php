...
<section class="bg-bone section-padding">
  <div class="section-container max-w-2xl text-center">
    ...
    <a href="https://wa.me/{{ ltrim($settings->whatsapp_number, '+') }}?text={{ urlencode('Hello Nails by Mona, I\'d like to send my sizing photos.') }}" class="btn-primary mt-8 inline-flex">Send photos on WhatsApp</a>
  </div>
</section>
@endsection
