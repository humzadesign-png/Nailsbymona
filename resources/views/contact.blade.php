      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="bg-bone rounded-2xl p-6 flex items-start gap-5 border border-hairline/60">
          ...
          <div>
            ...
            <a href="mailto:{{ $settings->contact_email }}" class="font-sans text-caption text-lavender-ink hover:text-lavender underline-offset-4 hover:underline transition-colors duration-200">{{ $settings->contact_email }} &rarr;</a>
          </div>
        </div>
